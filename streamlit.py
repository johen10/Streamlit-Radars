...
xlsx_directory = r'data'  # Make sure this directory contains your CSV files

# Get a list of CSV files in the directory
xlsx_files = [f for f in os.listdir(r'data') if f.endswith('.xlsx')]
...
data_path = os.path.join(r'data', selected_file)
